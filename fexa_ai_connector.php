...
class Fexa_ai_connector extends Module
{
    ...
    public function getContent()
    {
        ...
        $intro = $this->l('Optimisez automatiquement le SEO de votre boutique avec l\'IA : descriptions, méta, balises ALT et données structurées (FAQ, Produit, fil d\'ariane).');
