...
it('calls the handler with prepared arguments', function () {
    ...
    $resultContents = $tool->call($this->container, ['a' => 5, 'b' => '10']); 
...
it('formats mixed array from handler into array of Content objects', function () {
    ...
    expect($resultContents[1])->toBeInstanceOf(TextContent::class)->text->toBe("A TextContent object"); 
    ...
    expect($resultContents[6])->toBeInstanceOf(ImageContent::class)->data->toBe("img_data_mixed"); 
