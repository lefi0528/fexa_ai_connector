...
return array(
    ...
    'Fexa_ai_connector' => $baseDir . '/fexa_ai_connector.php',
    ...
    'PhpMcp\\Client\\Cache\\DefinitionCache' => $vendorDir . '/php-mcp/client/src/Cache/DefinitionCache.php',
    'PhpMcp\\Client\\Client' => $vendorDir . '/php-mcp/client/src/Client.php',
    'PhpMcp\\Client\\ClientBuilder' => $vendorDir . '/php-mcp/client/src/ClientBuilder.php',
    'PhpMcp\\Client\\ClientConfig' => $vendorDir . '/php-mcp/client/src/ClientConfig.php',
    'PhpMcp\\Client\\Contracts\\ContentInterface' => $vendorDir . '/php-mcp/client/src/Contracts/ContentInterface.php',
    'PhpMcp\\Client\\Contracts\\LoopAwareInterface' => $vendorDir . '/php-mcp/client/src/Contracts/LoopAwareInterface.php',
    'PhpMcp\\Client\\Contracts\\TransportInterface' => $vendorDir . '/php-mcp/client/src/Contracts/TransportInterface.php',
    'PhpMcp\\Client\\Enum\\ConnectionStatus' => $vendorDir . '/php-mcp/client/src/Enum/ConnectionStatus.php',
    'PhpMcp\\Client\\Enum\\TransportType' => $vendorDir . '/php-mcp/client/src/Enum/TransportType.php',
    'PhpMcp\\Client\\Event\\AbstractNotificationEvent' => $vendorDir . '/php-mcp/client/src/Event/AbstractNotificationEvent.php',
    'PhpMcp\\Client\\Event\\LogReceived' => $vendorDir . '/php-mcp/client/src/Event/LogReceived.php',
    'PhpMcp\\Client\\Event\\PromptsListChanged' => $vendorDir . '/php-mcp/client/src/Event/PromptsListChanged.php',
    'PhpMcp\\Client\\Event\\ResourceChanged' => $vendorDir . '/php-mcp/client/src/Event/ResourceChanged.php',
    'PhpMcp\\Client\\Event\\ResourcesListChanged' => $vendorDir . '/php-mcp/client/src/Event/ResourcesListChanged.php',
    'PhpMcp\\Client\\Event\\SamplingRequestReceived' => $vendorDir . '/php-mcp/client/src/Event/SamplingRequestReceived.php',
    'PhpMcp\\Client\\Event\\ToolsListChanged' => $vendorDir . '/php-mcp/client/src/Event/ToolsListChanged.php',
    'PhpMcp\\Client\\Exception\\ConfigurationException' => $vendorDir . '/php-mcp/client/src/Exception/ConfigurationException.php',
    'PhpMcp\\Client\\Exception\\ConnectionException' => $vendorDir . '/php-mcp/client/src/Exception/ConnectionException.php',
    'PhpMcp\\Client\\Exception\\DefinitionException' => $vendorDir . '/php-mcp/client/src/Exception/DefinitionException.php',
    'PhpMcp\\Client\\Exception\\McpClientException' => $vendorDir . '/php-mcp/client/src/Exception/McpClientException.php',
    'PhpMcp\\Client\\Exception\\ProtocolException' => $vendorDir . '/php-mcp/client/src/Exception/ProtocolException.php',
    'PhpMcp\\Client\\Exception\\RequestException' => $vendorDir . '/php-mcp/client/src/Exception/RequestException.php',
    'PhpMcp\\Client\\Exception\\TimeoutException' => $vendorDir . '/php-mcp/client/src/Exception/TimeoutException.php',
    'PhpMcp\\Client\\Exception\\TransportException' => $vendorDir . '/php-mcp/client/src/Exception/TransportException.php',
    'PhpMcp\\Client\\Exception\\UnsupportedCapabilityException' => $vendorDir . '/php-mcp/client/src/Exception/UnsupportedCapabilityException.php',
    'PhpMcp\\Client\\Factory\\MessageIdGenerator' => $vendorDir . '/php-mcp/client/src/Factory/MessageIdGenerator.php',
    'PhpMcp\\Client\\Factory\\TransportFactory' => $vendorDir . '/php-mcp/client/src/Factory/TransportFactory.php',
    'PhpMcp\\Client\\JsonRpc\\Error' => $vendorDir . '/php-mcp/client/src/JsonRpc/Error.php',
    'PhpMcp\\Client\\JsonRpc\\Message' => $vendorDir . '/php-mcp/client/src/JsonRpc/Message.php',
    'PhpMcp\\Client\\JsonRpc\\Notification' => $vendorDir . '/php-mcp/client/src/JsonRpc/Notification.php',
    'PhpMcp\\Client\\JsonRpc\\Params\\InitializeParams' => $vendorDir . '/php-mcp/client/src/JsonRpc/Params/InitializeParams.php',
    'PhpMcp\\Client\\JsonRpc\\Params\\SubscribeResourceParams' => $vendorDir . '/php-mcp/client/src/JsonRpc/Params/SubscribeResourceParams.php',
    'PhpMcp\\Client\\JsonRpc\\Request' => $vendorDir . '/php-mcp/client/src/JsonRpc/Request.php',
    'PhpMcp\\Client\\JsonRpc\\Response' => $vendorDir . '/php-mcp/client/src/JsonRpc/Response.php',
    'PhpMcp\\Client\\JsonRpc\\Result' => $vendorDir . '/php-mcp/client/src/JsonRpc/Result.php',
    'PhpMcp\\Client\\JsonRpc\\Results\\CallToolResult' => $vendorDir . '/php-mcp/client/src/JsonRpc/Results/CallToolResult.php',
    'PhpMcp\\Client\\JsonRpc\\Results\\EmptyResult' => $vendorDir . '/php-mcp/client/src/JsonRpc/Results/EmptyResult.php',
    'PhpMcp\\Client\\JsonRpc\\Results\\GetPromptResult' => $vendorDir . '/php-mcp/client/src/JsonRpc/Results/GetPromptResult.php',
    'PhpMcp\\Client\\JsonRpc\\Results\\InitializeResult' => $vendorDir . '/php-mcp/client/src/JsonRpc/Results/InitializeResult.php',
    'PhpMcp\\Client\\JsonRpc\\Results\\ListPromptsResult' => $vendorDir . '/php-mcp/client/src/JsonRpc/Results/ListPromptsResult.php',
    'PhpMcp\\Client\\JsonRpc\\Results\\ListResourceTemplatesResult' => $vendorDir . '/php-mcp/client/src/JsonRpc/Results/ListResourceTemplatesResult.php',
    'PhpMcp\\Client\\JsonRpc\\Results\\ListResourcesResult' => $vendorDir . '/php-mcp/client/src/JsonRpc/Results/ListResourcesResult.php',
    'PhpMcp\\Client\\JsonRpc\\Results\\ListToolsResult' => $vendorDir . '/php-mcp/client/src/JsonRpc/Results/ListToolsResult.php',
    'PhpMcp\\Client\\JsonRpc\\Results\\ReadResourceResult' => $vendorDir . '/php-mcp/client/src/JsonRpc/Results/ReadResourceResult.php',
    'PhpMcp\\Client\\Model\\Capabilities' => $vendorDir . '/php-mcp/client/src/Model/Capabilities.php',
    'PhpMcp\\Client\\Model\\Content\\AudioContent' => $vendorDir . '/php-mcp/client/src/Model/Content/AudioContent.php',
    'PhpMcp\\Client\\Model\\Content\\ContentFactory' => $vendorDir . '/php-mcp/client/src/Model/Content/ContentFactory.php',
    'PhpMcp\\Client\\Model\\Content\\EmbeddedResource' => $vendorDir . '/php-mcp/client/src/Model/Content/EmbeddedResource.php',
    'PhpMcp\\Client\\Model\\Content\\ImageContent' => $vendorDir . '/php-mcp/client/src/Model/Content/ImageContent.php',
    'PhpMcp\\Client\\Model\\Content\\PromptMessage' => $vendorDir . '/php-mcp/client/src/Model/Content/PromptMessage.php',
    'PhpMcp\\Client\\Model\\Content\\ResourceContent' => $vendorDir . '/php-mcp/client/src/Model/Content/ResourceContent.php',
    'PhpMcp\\Client\\Model\\Content\\TextContent' => $vendorDir . '/php-mcp/client/src/Model/Content/TextContent.php',
    'PhpMcp\\Client\\Model\\Definitions\\PromptArgumentDefinition' => $vendorDir . '/php-mcp/client/src/Model/Definitions/PromptArgumentDefinition.php',
    'PhpMcp\\Client\\Model\\Definitions\\PromptDefinition' => $vendorDir . '/php-mcp/client/src/Model/Definitions/PromptDefinition.php',
    'PhpMcp\\Client\\Model\\Definitions\\ResourceDefinition' => $vendorDir . '/php-mcp/client/src/Model/Definitions/ResourceDefinition.php',
    'PhpMcp\\Client\\Model\\Definitions\\ResourceTemplateDefinition' => $vendorDir . '/php-mcp/client/src/Model/Definitions/ResourceTemplateDefinition.php',
    'PhpMcp\\Client\\Model\\Definitions\\ToolDefinition' => $vendorDir . '/php-mcp/client/src/Model/Definitions/ToolDefinition.php',
    'PhpMcp\\Client\\ServerConfig' => $vendorDir . '/php-mcp/client/src/ServerConfig.php',
    'PhpMcp\\Client\\StreamLogger' => $vendorDir . '/php-mcp/client/src/StreamLogger.php',
    'PhpMcp\\Client\\Transport\\Http\\HttpClientTransport' => $vendorDir . '/php-mcp/client/src/Transport/Http/HttpClientTransport.php',
    'PhpMcp\\Client\\Transport\\Http\\Psr7StreamAdapter' => $vendorDir . '/php-mcp/client/src/Transport/Http/Psr7StreamAdapter.php',
    'PhpMcp\\Client\\Transport\\Stdio\\StdioClientTransport' => $vendorDir . '/php-mcp/client/src/Transport/Stdio/StdioClientTransport.php',
    'PhpMcp\\Client\\Utils' => $vendorDir . '/php-mcp/client/src/Utils.php',
    ...
    'PrestaShop\\Module\\FexaAiConnector\\Controller\\Admin\\FexaAiConfigController' => $baseDir . '/src/Controller/Admin/FexaAiConfigController.php',
    'PrestaShop\\Module\\FexaAiConnector\\Http\\Client' => $baseDir . '/src/Http/Client.php',
    'PrestaShop\\Module\\FexaAiConnector\\Http\\HttpConstants' => $baseDir . '/src/Http/HttpConstants.php',
    'PrestaShop\\Module\\FexaAiConnector\\Http\\SegmentClient' => $baseDir . '/src/Http/SegmentClient.php',
    'PrestaShop\\Module\\FexaAiConnector\\Legacy\\Server' => $baseDir . '/src/Legacy/Server.php',
    'PrestaShop\\Module\\FexaAiConnector\\Legacy\\Tools\\ProductTool' => $baseDir . '/src/Legacy/Tools/ProductTool.php',
    'PrestaShop\\Module\\FexaAiConnector\\Repository\\McpModulesRegisteredRepository' => $baseDir . '/src/Repository/McpModulesRegisteredRepository.php',
    'PrestaShop\\Module\\FexaAiConnector\\Repository\\McpToolsRepository' => $baseDir . '/src/Repository/McpToolsRepository.php',
    'PrestaShop\\Module\\FexaAiConnector\\Server\\CustomDiscoverer' => $baseDir . '/src/Server/CustomDiscoverer.php',
    'PrestaShop\\Module\\FexaAiConnector\\Server\\CustomFileCache' => $baseDir . '/src/Server/CustomFileCache.php',
    'PrestaShop\\Module\\FexaAiConnector\\Server\\InMemoryTransport' => $baseDir . '/src/Server/InMemoryTransport.php',
    'PrestaShop\\Module\\FexaAiConnector\\Services\\McpModulesRegisteredService' => $baseDir . '/src/Services/McpModulesRegisteredService.php',
    'PrestaShop\\Module\\FexaAiConnector\\Services\\McpService' => $baseDir . '/src/Services/McpService.php',
    'PrestaShop\\Module\\FexaAiConnector\\Services\\McpToolsService' => $baseDir . '/src/Services/McpToolsService.php',
